...
\begin{figure}
\label{fig1}
\includegraphics[width = 15cm]{figs/IIR_Cheb_lp.eps}
...
\begin{figure}
\label{fig2}
\includegraphics[width = 15cm]{figs/IIR_Cheb_lpDesign.eps}
...
\begin{figure}
\label{fig3}
\includegraphics[width = 15cm]{figs/IIR_Analogbp.eps}
...
\begin{figure}
\label{fig4}
\includegraphics[width = 15cm]{figs/IIR_Digitalbp.eps}
